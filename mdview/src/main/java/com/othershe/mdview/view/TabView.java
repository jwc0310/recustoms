package com.othershe.mdview.view;
...
public class TabView extends FrameLayout {
    ...
    public TabView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        inflate(context, R.layout.wx_tab_layout, this);
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            switch (attr) {
                case R.styleable.TabView_tabColor:
                    //标题和轮廓最终着色
                    mTargetColor = typedArray.getColor(attr, DEFAULT_TAB_TARGET_COLOR);
                    break;
