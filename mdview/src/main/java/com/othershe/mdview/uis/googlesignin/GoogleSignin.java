package com.othershe.mdview.uis.googlesignin;
...
//        updateUI(account);
    ...
    private void updateUI(@Nullable GoogleSignInAccount account) {
        if (account != null) {
            textStatus.setText(getString(R.string.signed_in_fmt, account.getDisplayName()));
            detail.setText(account.toJson());
            Log.e(TAG, "id = " + account.getId());
            Log.e(TAG, "idToken = " + account.getIdToken());

            findViewById(R.id.sign_in_button).setVisibility(View.GONE);
            findViewById(R.id.sign_out_and_disconnect).setVisibility(View.VISIBLE);
        } else {
            textStatus.setText(R.string.signed_out);
            detail.setText("");
