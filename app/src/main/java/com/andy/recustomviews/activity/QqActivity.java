...
import com.andy.recustomviews.views.SwipeLayout;
import com.andy.recustomviews.views.SwipeLayoutManager;
...
public class QqActivity extends BaseActivity {
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> implements SwipeLayout.OnSwipeStateChangeListener {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder Holder = new MyViewHolder(LayoutInflater.from(QqActivity.this).
        ...
        public void onOpen(Object tag) {
            Toast.makeText(QqActivity.this,"第"+(Integer)tag+"个打开", 0).show();
        }
        @Override
        public void onClose(Object tag) {
            Toast.makeText(QqActivity.this,"第"+(Integer)tag+"个关闭", 0).show();
        }
